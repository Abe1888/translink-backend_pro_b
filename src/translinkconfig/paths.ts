...
export const CAMERA_CONFIG = {
    // 55° gives a natural cinematic perspective with convincing depth parallax.
    // 35° was a telephoto lens that crushed depth and made the scene feel flat.
    fov: 55,
    // Tighter near plane lets the camera get very close without clipping artifacts
    near: 0.05,
    far: 1000,
